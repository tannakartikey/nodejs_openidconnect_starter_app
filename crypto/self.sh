...
SUBJ="/C=US/ST=Virginia/L=Leesburg/O=Qryptograph LLC/CN=Qryptograph Localhost Test CA"
...
SUBJ="/C=US/ST=Virginia/L=Leesburg/O=Qryptograph LLC/CN=localhost.qryptograph.test"
